...
export const NAVIGATION_LINKS = [
  {
    ...
    childrenLinks: [
      ...
      },
      {
        ...
        key: 'nature',
        description:
          'Nature is beautiful, and I love capturing it. Check out my nature photography portfolio!',
      },
      {
        name: 'Landscape',
...
export const TYPES_OF_PHOTOGRAPHY = [
  'Urban Landscapes',
  'Wildlife Moments',
  'Wedding Stories',
  'Street Photography',
...
export const PHOTOGRAPHER_INSIGHTS = [
  'Love for Light',
  'Happy Snaps',
  'Fleeting Smiles',
  'Seeing Magic',
