...
import { WithClassName, WithChildren } from '@/types/UI';

type NavLinkProps = WithClassName &
    WithChildren &
...
const NavLink = ({ children, className, activeClassName, onClick, ...props }: NavLinkProps) => {
    const pathname = usePathname();
    const [computedClassName, setComputedClassName] = useState(className);

    useEffect(() => {
        const linkPath = new URL(props.as?.toString() || props.href.toString(), location.href).pathname;
